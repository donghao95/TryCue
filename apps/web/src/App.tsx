...
import type { FocusEvent as ReactFocusEvent, KeyboardEvent as ReactKeyboardEvent, ReactNode, UIEvent } from "react";
import {
  closestCenter,
  DndContext,
  KeyboardSensor,
...
import { AlertTriangle, CheckCircle2, ChevronLeft, ChevronRight, Eye, Heart, History, Home, ImageUp, Loader2, MessageCircle, PencilLine, Play, RefreshCw, Save, Send, Settings, Share2, Star, Trash2, X } from "lucide-react";
...
import { AnimatedCommentList, AudienceAvatar, DrawerField, PostAction, SeatCell, VenueHud } from "./components/VenueWidgets.js";
...
function timelineKindLabel(kind: DrawerTimelineKind): string {
...
type SimulatedPostSurfaceProps = {
  actionBar?: ReactNode;
...
function PlanningContentPreview({
  activeImageUrl,
  bodyText,
  imageUrls,
  onOpenImage,
...
function formatMobilePostDate(date: Date) {
